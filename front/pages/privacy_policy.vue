    ...
    <v-row justify="center" no-gutters>
      <v-col xl="8" md="12">
        <v-card class="pa-6">
          <h2>プライバシーポリシー</h2>
          <p>
            MokuTube（以下，「当方」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
          </p>
          ...
          <p>
            本ポリシーに関するお問い合わせは，
            <a
              href="https://twitter.com/takasho1024"
              target="_blank"
...
export default {
  ...
  auth: false,
  layout({ $auth }) {
    return $auth.loggedIn ? 'logged-in' : ''
  },
  head() {
    return {
      title: 'プライバシーポリシー',
